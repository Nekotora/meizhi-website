		...
		<form id="tableForm" name="tableForm" action="./?v=signup&a=post" method="post">
			<div id="table">
				...
				<div id="space_info" class="info_div">
					<label class="normal_label" for="space_check">申请的摊位类型：</label>
					<div id="space_check" class="sub_div">
						<label class="radio_label" for="one_space"><input id="one_space" type="radio" value="1" name="space" checked>普通摊位</label>
	   					<label class="radio_label" for="two_space"><input id="two_space" type="radio" value="2" name="space">游戏摊位</label>
					</div>
					<label class="normal_label" for="nearby">希望与哪个社团相邻（仅相同摊位类型的社团可连摊）：</label>
					<input type="text" id="nearby" name="nearby" class="input_long" maxlength="255" placeholder="请输入社团名" />
				</div>
				<div id="work_info" class="info_div">
					<div class="line_div">
						<label class="line_first line_label">作品名（仅审核参考，不直接影响结果）：</label>
