				...
				return self.raise('predraw.ft.table').then(function(){
					return self.execute(false, true, 'draw').then(function(){
						...
						return self.raise('draw.ft.table').then(function(){
							if (typeof(makeid)=="function") makeid(storecolumn, storedirection);
...
(function ($, F) {
	F.Filtering = F.Component.extend(/** @lends FooTable.Filtering */{
		...
		$create: function () {
			...
			self.$form = $('<form/>', {'class': 'form-inline', 'method': 'post', 'action': '#', 'onsubmit': 'return false;'}).append($form_grp).appendTo(self.$cell);
			
			// add function
			formObj = $('<div/>', {'class': 'form-left-tip'});
			$form_grp.before(formObj);
			...
			self.$input.on('keypress',function(event){
				if(event.keyCode == "13") {
		...
		filter: function(){
			...
			return self.ft.raise('before.ft.filtering', [self.filters]).then(function(){
				...
				tableStatus = "filtering";
				if (self.filters.length <= 0) {
					var $loader = $('<div/>', { 'class': 'footable-loader' }).append($('<span/>', {'class': 'fooicon fooicon-loader'}));
					tableObj.hide().after($loader);
				}
...
(function ($, F) {
	F.Sorting = F.Component.extend(/** @lends FooTable.Sorting */{
		...
		init: function () {
			 ...
			 */
			var self = this;
			if (typeof(preid)=="function") preid(self.column.index, self.column.direction);			
		...
		_sort: function(column, direction){
			...
			if (typeof(preid)=="function") preid(column, direction);
			var self = this;
	...
	F.Sorting.dir = function(str){
		return F.is.string(str) && (str == 'ASC' || str == 'DESC') ? str : 'DESC';
	};
