		...
		<form id="tableForm" name="tableForm" action="./?v=signup&a=post" method="post">
			<div id="table">
				...
				<div id="space_info" class="info_div">
					<label class="normal_label" for="space_check">お申し込むスペース：</label>
					<div id="space_check" class="sub_div">
						<label class="radio_label" for="one_space"><input id="one_space" type="radio" value="1" name="space" checked>一般スペース</label>
	   					<label class="radio_label" for="two_space"><input id="two_space" type="radio" value="2" name="space">ゲーム展示スペース</label>
					</div>
					
					<label class="normal_label" for="nearby">隣接配置希望サークル名（同じエリア(一般/ゲーム)のみ隣接配置できます）：</label>
